...
| [`environments/deployment.md`](../../wiki/environments/deployment.md) | Running the service as a container: the three build stages, what is on the volume, why the healthcheck is readiness, how the panel sits in front of it, and what a host that builds the image needs set. |
